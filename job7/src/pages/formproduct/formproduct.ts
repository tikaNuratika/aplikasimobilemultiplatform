...
export class FormproductPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private viewCtrl: ViewController, private productProvider: ProductProvider,private alertProvider: AlertProvider, private event: Events, private camera: Camera, private filePath: FilePath, private file: File, private actionSheetCtrl: ActionSheetController, private loadingCtrl: LoadingController) {
  }
  ...
  //fungsi untuk membuka kamera atau galery foto
  getImage(sourceType){
    ...
    const options: CameraOptions = {
      ...
      //type sumber apakah camera atau gallery foto
      sourceType: sourceType
    }
    //printah untuk mendapatkan image
    this.camera.getPicture(options).then((imagePath) => {
      //hasil image yang diminta dalam bentuk path
      this.imageUri = imagePath;
      //printah untuk mendapatkan name file
  ...
  //fungsi untuk membuat ActionSheet
  presentActionSheet(){
